<div class="btn-group">
    ...
    <div class="dropdown-menu dropdown-menu-right">
      ...
      @if($data->agenda_number != null)
        <a href="{{ route('incommingmail.edit', encrypt($data->id)) }}" type="button" class="dropdown-item drpdwn" type="button"><span class="mdi mdi-file-edit"></span> | Ubah Data Keseluruhan</a>
      @endif
    </div>
</div>