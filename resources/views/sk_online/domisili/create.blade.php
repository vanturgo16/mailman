    ...
    <div class="row mb-2">
      <div class="col-sm-6">
        <button type="button" class="btn btn-outline-primary" data-toggle="modal" data-target="#modal-lg">
          Klik di Sini Untuk Mencari Surat Keterangan Domisili Yang Telah Anda Ajukan
        </button>
        @error('cari')
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        <div class="card card-primary card-outline">
          ...
          <form action="/surat-online-domisili" method="POST" enctype="multipart/form-data">
            @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-12 col-sm-6">
                    <div class="form-group">
                      ...
                      <div class="select2-purple">
                        <input type="text" name="negara"value="Indonesia" readonly 
                ...
                <div class="form-group">
                  {!! RecaptchaV3::initJs() !!}
                  {!! RecaptchaV3::field('sk_domisilis') !!}
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Form Pencarian Ajuan Domisili</h4>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form action="/surat-online-domisili/cari" method="GET" >
          {{--  @csrf  --}}
