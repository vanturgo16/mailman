                                    ...
                                    <div class="card-body">
                                        ...
                                        <table id="example3" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <td>{{ $data->kapasitas_gedung . " Lantai" }} {{ $data->is_active }}</td>
                                                <td>
                                                    @if ($data->is_active == '1')
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <form action="{{ url('/gedung/aktif', encrypt($data->id)) }}" method="POST" style="display:inline-block;">
                                                            @csrf
                                                            @method('PATCH')
                                                            <button type="submit" class="btn btn-danger btn-xs" onclick="return confirm('Yakin Aktifkan Gedung?')">Aktif Data</button>
                                                        </form>
