                    ...
                    @foreach ($warga as $no => $kat)
                        <tr>
                            ...
                            <td class="text-center">
                                    ...
                                    <a href="/pesan/{{$kat->id}}/show" class="btn btn-xs btn-info">
                                        <i class="fa fa-check"></i> 
                                     </a>
                                  <form method="POST" class="d-inline" onsubmit="return confirm('Masukan ke tempat sampah?')" action="/data-pesan/{{ $kat->id }}/destroy">
                                    @csrf
