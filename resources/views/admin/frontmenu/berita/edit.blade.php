        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/data-berita/update/{{ $posts->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                  <div class="card-body">
                    <div class="row">
                      ...
                      @enderror
                        ...
                        <div class="form-group">
                          ...
                          <input type="file" name="image"value="{{ old('image',$posts->image) }}"
                      class="form-control @error('image') is-invalid @enderror" id="exampleInputEmail1"
                      placeholder="Masukan Telpon " >
                      <p></p>
                      <img src="{{ Storage::url('public/berita/'.$posts->image) }}" style="width: 100px">
                        ...
                        <div class="col-12 col-sm-12">
                          <div class="form-group">
                            <label>Isi Berita</label>
                                ...
                                <textarea id="summernote" class="form-control content @error('content',$posts->content) is-invalid @enderror" name="content" placeholder="Masukkan Konten / Isi Berita" >
