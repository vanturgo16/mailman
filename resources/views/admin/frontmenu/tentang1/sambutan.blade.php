...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">
           <a href="/about-desa"> Edit Sambutan</h1></a>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/about-desa/update/{{ $sambutan->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>Nama </label>
                          <input type="text" name="email" hidden value="{{ Auth::user()->name }}">
                          <input type="text" name="nm_kep"value="{{ old('nm_kep',$sambutan->nm_kep) }}" 
                      class="form-control @error('nm_kep') is-invalid @enderror" id="exampleInputEmail1" 
                      ...
                      @enderror
                        ...
                        <div class="form-group">
                          ...
                          <label>Foto  *format file jpeg,jpg,png || max:2000</label>
                          <input type="file" name="foto"value="{{ old('foto') }}" 
                      class="form-control @error('foto') is-invalid @enderror" id="exampleInputEmail1" 
