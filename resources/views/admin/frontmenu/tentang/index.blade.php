                    ...
                    <ul class="nav nav-tabs" id="custom-tabs-one-tab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="custom-tabs-one-messages-tab" data-toggle="pill"
                                ...
                                aria-selected="false">Sejarah Singkat</a>
                        </li>
                        {{--  <li class="nav-item">
                    ...
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        <div class="tab-pane fade show active" id="custom-tabs-one-home" role="tabpanel"
                            ...
                            <div class="input-group-prepend">
                                ...
                                <a href="/about-profil/edit/{{ $sambutan->id }}" class="btn btn-primary"
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel"
                            ...
                            <div class="input-group-prepend">
                                ...
                                <a href="/about-profil/edit_visimisi/{{ $visi->id }}" class="btn btn-primary"
                                    style="padding-top: 10px;">
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-messages" role="tabpanel"
                            ...
                            <div class="input-group-prepend">
                                ...
                                <a href="/about-profil/edit_sejarah/{{ $sejarah->id }}" class="btn btn-primary"
                                    style="padding-top: 10px;">
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-settings" role="tabpanel"
                            ...
                            <div class="input-group-prepend">
                                ...
                                <a href="/about-profil/edit-potensi/{{ $potensi->id }}" class="btn btn-primary"
                                    style="padding-top: 10px;">
                            ...
                            <table id="example1"class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ Storage::url('public/staff/' . $potensi->image) }}"
                                            style="width: 100px">
