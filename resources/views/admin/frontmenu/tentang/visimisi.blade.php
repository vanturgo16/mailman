                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="/about-profil/update_visimisi/{{ $visimisi->id }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control content @error('visi') is-invalid @enderror" name="visi"
                              ...
                              {!! old('visi', $visimisi->visi) !!}  
                                        ...
                                        <div class="col-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote" rows="5" class="form-control content @error('misi') is-invalid @enderror" name="misi"
                                                    placeholder="Masukkan sejarah">
