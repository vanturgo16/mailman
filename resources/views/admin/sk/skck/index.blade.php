...
@section('content')
 <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Surat Keterangan Berkelakuan Baik</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <table id="example3"class="table table-bordered">
                                      ...
                                      <center><span class="badge badge-secondary">Kristen</label></center>
                                          ...
                                          <center><span class="badge badge-success">Hindu</label></center>
                                              ...
                                              <center><span class="badge badge-warning">Buddha</label></center>
                                                  @elseif($kat->agama == 5)
                                                  <center><span class="badge badge-danger">Konghucu</label></center>
                                  @endif 
                        ...
                        {{--  <a href="/domisili/show/{{$kat->id}}" rel="noopener" target="_blank" class="btn btn-xs btn-default">
                          ...
                          <a href="/skck/edit/{{$kat->id}}" class="btn btn-xs btn-info">
                             <i class="fa fa-check"></i> Lihat
                          </a>
                          <form method="POST" class="d-inline" onsubmit="return confirm('Masukan ke tempat sampah?')" action="/skck/{{ $kat->id }}/destroy">
                            @csrf
            ...
            <div class="tab-pane fade" id="custom-tabs-two-messages" role="tabpanel" aria-labelledby="custom-tabs-two-messages-tab">
              <div class="card-body">
                ...
                <table id="example4"class="table table-bordered">
                    ...
                    <form method="POST" action="/skck/{{ $kat->id }}/restore" class="d-inline">
                      @csrf
                      <button type="submit" value="Restore" class="btn btn-xs btn-success"/>
                      Restor <i class="fas fa-undo"></i>
                  </form>
                  
                  <form method="POST" action="/skck/{{ $kat->id }}/delete-permanent" class="d-inline" onsubmit="return confirm('
