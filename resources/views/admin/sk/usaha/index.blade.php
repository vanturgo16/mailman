                ...
                <div class="card-body">
                    ...
                    <table id="example3"class="table table-bordered">
                        ...
                        {{--  <a href="/domisili/show/{{$kat->id}}" rel="noopener" target="_blank" class="btn btn-xs btn-default">
                          ...
                          <a href="/usaha/edit/{{$kat->id}}" class="btn btn-xs btn-info">
                             <i class="fa fa-check"></i> Lihat
                          </a>

                          <form method="POST" class="d-inline" onsubmit="return confirm('Masukan ke tempat sampah?')" action="/usaha/{{ $kat->id }}/destroy">
                            @csrf
                    ...
                    @foreach ($usaha_trash as $no => $kat)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <form method="POST" action="/usaha/{{ $kat->id }}/restore" class="d-inline">
                                  @csrf
                                  <button type="submit" value="Restore" class="btn btn-xs btn-success"/>
                                  Restor <i class="fas fa-undo"></i>
                              </form>
                              
                              <form method="POST" action="/usaha/{{ $kat->id }}/delete-permanent" class="d-inline" onsubmit="return confirm('
