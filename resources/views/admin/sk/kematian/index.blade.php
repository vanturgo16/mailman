                        ...
                        @foreach ($skmatian as $no => $kat)
                            <tr>
                                ...
                                <td class="text-center">
                                    {{--  @can('users.edit')  --}}
                              <a href="/sk-kematian/edit/{{$kat->id}}" class="btn btn-xs btn-info">
                                <i class="fa fa-check"></i> Lihat
                              </a>  

                              <form method="POST" class="d-inline" onsubmit="return confirm('Masukan ke tempat sampah?')" action="/sk-kematian/{{ $kat->id }}/destroy">
                                @csrf
            ...
            <div class="tab-pane fade" id="custom-tabs-two-messages" role="tabpanel" aria-labelledby="custom-tabs-two-messages-tab">
              <div class="card-body">
                ...
                <table id="example3"class="table table-bordered">
                    ...
                    <tbody>
                    @foreach ($skmatian_trash as $no => $kat)
                        <tr>
                            <th scope="row" style="text-align: center">{{ ++$no}}</th>
                            <td>{{ $kat->nama }}</td>
                            <td>{{ $kat->tempat }}, {{ $kat->tgl }}</td>
                            ...
                            <td class="text-center">
                                {{--  @can('users.edit')  --}}
                                <form method="POST" action="/sk-kematian/{{ $kat->id }}/restore" class="d-inline">
                                  @csrf
                                  <button type="submit" value="Restore" class="btn btn-xs btn-success"/>
                                  Restor <i class="fas fa-undo"></i>
                              </form>
                              
                              <form method="POST" action="/sk-kematian/{{ $kat->id }}/delete-permanent" class="d-inline" onsubmit="return confirm('
