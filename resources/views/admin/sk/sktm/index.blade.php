...
<div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Surat Keterangan Kurang Mampu</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                        ...
                        @foreach ($sktm as $no => $kat)
                            <tr>
                                ...
                                <td class="text-center">
                                    {{--  @can('users.edit')  --}}
                                    <a href="/sktm/edit/{{$kat->id}}" class="btn btn-xs btn-info">
                                      <i class="fa fa-check"></i> Lihat
                                    </a>  
      
                                    <form method="POST" class="d-inline" onsubmit="return confirm('Masukan ke tempat sampah?')" action="/sktm/{{ $kat->id }}/destroy">
                                      @csrf
                ...
                <table id="example4"class="table table-bordered">
                    ...
                    @foreach ($sktm_trash as $no => $kat)
                        <tr>
                            ...
                            <td class="text-center">
                                {{--  @can('users.edit')  --}}
                                <form method="POST" action="/sktm/{{ $kat->id }}/restore" class="d-inline">
                                  @csrf
                                  <button type="submit" value="Restore" class="btn btn-xs btn-success"/>
                                  Restor <i class="fas fa-undo"></i>
                              </form>
                              
                              <form method="POST" action="/sktm/{{ $kat->id }}/delete-permanent" class="d-inline" onsubmit="return confirm('
