        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/opd/update/{{ $staff->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('patch')
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label>Nama Organisasi Perangkat Daerah (OPD)</label>
                          <input type="text" name="operator" hidden value="{{ Auth::user()->name }}">
                          <input type="text" name="nm_opd"value="{{ old('nm_opd',$staff->nm_opd) }}"
                      class="form-control @error('nm_opd') is-invalid @enderror" id="exampleInputEmail1"
                      placeholder="Masukan Nama Organisasi Perangkat Daerah (OPD)" required>
                      @error('nm_opd')
                      ...
                      @enderror
                        ...
                        <!-- /.form-group -->
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="singkatan"value="{{ old('singkatan',$staff->singkatan) }}"
                        ...
                        @enderror
                          ...
                          <div class="form-group">
                            ...
                            <select class="form-control select2" name="jenis" style="width: 100%;">
                                ...
                                @foreach ($jenis as $ag)
                                @if($staff->jenis == $ag->id)

                                <option value="{{ $ag->id  }}" selected> {{ $ag->nm_jenis}}</option>
                                 @else
                                <option value="{{ $ag->id  }}">{{ $ag->nm_jenis}}</option>
                                @endif
