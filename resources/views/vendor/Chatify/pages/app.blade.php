...
<div class="messenger">
    ...
    <div class="messenger-listView">
        ...
        <div class="m-header">
            <nav>
                <a href="#"><i class="fas fa-inbox"></i> <span class="messenger-headTitle">SI-AGEN MESSENGER </span> </a>
                {{-- header buttons --}}
        ...
        <div class="m-body contacts-container">
           ...
           <div class="@if($type == 'user') show @endif messenger-tab users-tab app-scroll" data-view="users">
               ...
               {{-- Contact --}}
               <div class="listOfContacts" style="width: 100%;height: calc(100% - 100px);position: relative;"></div>
           ...
           <div class="@if($type == 'group') show @endif messenger-tab groups-tab app-scroll" data-view="groups">
                {{-- items --}}
                <p style="text-align: center;color:rgb(238, 222, 222);margin-top:30px">
            ...
            <nav class="chatify-d-flex chatify-justify-content-between chatify-align-items-center">
                ...
                <nav class="m-header-right">
                   ...
                   @if(Auth::user()->utype == 'ADM')
                    ...
                    @else
                    <a href="/user/profile"><i class="fas fa-home"></i></a>
                    @endif
