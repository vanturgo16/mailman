...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">
                    <a href="/pejabat"> Form Data Ajuan</h1></a>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Form Data Ajuan</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form <small>Ajuan</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/ajuan-agenda" method="POST" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            <label>Ajuan yang di Undang</label>

                                            <select class="form-control select2 select2-danger" name="id_pejabat"
                                                data-dropdown-css-class="select2-danger" style="width: 100%;">

                                                @foreach ($pejabat as $jabatan)
                                                <option value="{{ $jabatan->id  }}" selected> {{ $jabatan->nm_pejabat}}
                                                    - {{ $jabatan->nm_jabatan}}</option>
                                                @endforeach
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <input type="url" name="map" value="{{ old('map') }}"
                ...
                <div class="row">
                    <div class="col-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="nm_kegiatan" class="form-control @error('nm_kegiatan') is-invalid @enderror"
