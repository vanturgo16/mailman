...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">
                    <a href="/ajuan-benner"> Form Data Pejabat</h1></a>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Form <small>Pejabat</small></h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="/ajuan-benner" method="POST" enctype="multipart/form-data">
                            @csrf
